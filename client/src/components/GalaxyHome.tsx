...
const APPS: AppDef[] = [
  ...
  { page: "books",         label: "BOOKS",               subLabel: "LIBRARY",              color: "#a78bfa", emissive: "#7c3aed", size: 3.00, orbitRadius: 24.0, angle: 115, ring: false, texturePath: "/textures/2k_jupiter.jpg"       },
